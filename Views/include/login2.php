            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form method="POST" action="<?php echo $pach?>home/login" class="md-float-material form-material">
                                ...
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        ...
                                        <div class="text-center">
                                            <img src="assets/images/logo2.jpg" alt="logo2.jpg" width="50%" style="border-radius: 50px;">
                                        </div>
                                            <p class="text-center">Sistema Municipal de Gestão de Veículos Automóveis e motorizados</p>
                                            <br>
                                        </div>
                                    </div>
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Usuário ou email</label>
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="#" class="text-right f-w-600"> Esqueci a senha?</a>
                                            </div>
                                        </div>
                                    </div>
